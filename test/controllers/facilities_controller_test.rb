...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference("Facility.count") do
      post facilities_url, params: { facility: { address: @facility.address, homepage: @facility.homepage, name: @facility.name, station: @facility.station, tel: @facility.tel } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { address: @facility.address, homepage: @facility.homepage, name: @facility.name, station: @facility.station, tel: @facility.tel } }
